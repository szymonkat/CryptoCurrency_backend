...
public class AllData extends VerticalLayout {
    ...
    public AllData(WalletServiceImpl walletService,
                   WalletItemServiceImpl walletItemService,
                   ExchangePortalServiceImpl exchangePortalService,
                   ItemToBuyServiceImpl itemToBuyService) {
